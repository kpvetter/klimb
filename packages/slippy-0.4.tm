...
# @@ Meta Begin
# Package map::slippy 0.4
# Meta as::build::date 2011-01-21
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        Mapping utilities
# Meta description     Common code for slippy based map packages
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.4}
# Meta require         math::constants
# Meta require         snit
# Meta subject         latitute geodesy zoom location slippy geography map
# Meta subject         longitude
# Meta summary         map::slippy
# @@ Meta End
...
snit::type map::slippy {
    ...
    typemethod {geo 2tile} {geo {fraction 0}} {
	::variable degtorad
	::variable pi
